...
public class LifeRulesTest {
	...
	public static class ParameterizedSucessfullyLifeRulesTest {
	...
	@RunWith(Parameterized.class)
	public static class ParameterizedInvalidParamsLifeRulesTest {

		@Parameters
		public static Collection<Object[]> data() {
			return Arrays.asList(new Object[][] { { -1, 0 }, { 2, 0 }, { -1, 2 }, { 2, 2 },
					{ -1, 1 }, { 2, 1 }, { -1, 3 }, { 2, 3 }, { -1, 4 }, { 2, 4 }, { -1, 5 },
